...
async function initStats() {
    ...
    $("#apiComCountVal").text(await settings.get('stats.resized') === undefined ? "0" : Object.keys(cmdsSent).length.toString());
        ...
        switch (cmdReceived) {
            ...
            case "device_info":
                ...
                if (fromBuffer.includes("DY")) {
                    ...
                    dValue = xmlDoc.getElementsByTagName("device_info")[0]["attributes"]["D3"].nodeValue
                    ...
                    if (!$("#dText").hasClass("build")) {
                        ...
                        $("#zTextVal").removeClass("text-red-800 text-green-800 text-blue-800")
                        $("#xTextVal").removeClass("text-red-800 text-green-800 text-blue-800")
                        $("#xText").text("X");
                        $("#yText").text("Y");
                        $("#zText").text("Z");
                        $("#dText").text("D");
